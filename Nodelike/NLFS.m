...
static JSValue *buildStatsObject(const uv_stat_t *s, JSValue *_Stats) {
    ...
    stats[@"dev"]       = [JSValue valueWithInt32:(int32_t)s->st_dev    inContext:context];
    stats[@"mode"]      = [JSValue valueWithInt32:(int32_t)s->st_mode   inContext:context];
    stats[@"nlink"]     = [JSValue valueWithInt32:(int32_t)s->st_nlink  inContext:context];
    stats[@"uid"]       = [JSValue valueWithInt32:(int32_t)s->st_uid    inContext:context];
    stats[@"gid"]       = [JSValue valueWithInt32:(int32_t)s->st_gid    inContext:context];
    stats[@"rdev"]      = [JSValue valueWithInt32:(int32_t)s->st_rdev   inContext:context];
    stats[@"ino"]       = [JSValue valueWithInt32:(int32_t)s->st_ino    inContext:context];
    stats[@"size"]      = [JSValue valueWithInt32:(int32_t)s->st_size   inContext:context];
    stats[@"blocks"]    = [JSValue valueWithInt32:(int32_t)s->st_blocks inContext:context];
